...
export function welcomeEmailMessage() {
  return `<!doctype html>
          ...
          <body>
              <div class="container">
              <div class="logo">
                  <img src="https://${process.env.SITE_URL}/logo.jpg" width="30" alt="Logo" />
                  <h3>StudentTray</h3>
              </div>
              <h2>Welcome to StudentTray</h2>
              <p>
                  Thank you for joining StudentTray, 
                  <a href="https://${process.env.SITE_URL}/support">Learn more about StudentTray</a>
              </p>
              
              <div class="footer">
                  <p><a href="https://${process.env.SITE_URL}/login">Log in</a></p>
              </div>
              </div>
          </body>
          </html>`;
