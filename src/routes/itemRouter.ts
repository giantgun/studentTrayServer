...
import { delete_item, edit_item, get_all_items, get_an_item, get_an_item_for_edit, get_item_images_url_for_delete, list_item, save_item_image_url } from "../controllers/itemController"
...
router.post("/:itemId/edit/image-url/:selectedIndex", asyncHandler(authorization), asyncHandler(save_item_image_url))
