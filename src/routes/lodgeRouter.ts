...
import {
  ...
  edit_lodge,
  get_a_lodge,
  get_a_lodge_for_edit,
  get_all_lodges,
  get_lodge_images_url_for_delete,
  list_lodge,
...
router.post(
  ...
  asyncHandler(edit_lodge),
);

router.get(
  "/:lodgeId/edit",
  asyncHandler(authorization),
  asyncHandler(get_a_lodge_for_edit),
);

router.post(
  "/:lodgeId/edit/image-url/:selectedIndex",
  asyncHandler(authorization),
  asyncHandler(save_lodge_image_url),
);

router.get(
  "/:lodgeId/delete",
  asyncHandler(authorization),
  asyncHandler(get_lodge_images_url_for_delete),
  asyncHandler(delete_files_conditionally),
  asyncHandler(delete_lodge),
);
