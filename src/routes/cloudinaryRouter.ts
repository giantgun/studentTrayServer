...
router.get("/user/profile-photo",  asyncHandler(authorization), asyncHandler(get_user_photo_url_for_overwrite), asyncHandler(get_image_signature))

router.get("/business/profile-photo",  asyncHandler(authorization), asyncHandler(get_business_photo_url_for_overwrite), asyncHandler(get_image_signature))

router.get("/business/cover-photo",  asyncHandler(authorization), asyncHandler(get_business_cover_photo_url_for_overwrite), asyncHandler(get_image_signature))
