...
router.get("/item/:itemId/image/:selectedIndex",  asyncHandler(authorization), asyncHandler(get_item_image_url_for_overwrite), asyncHandler(get_file_signature))

router.get("/service/:serviceId/image/:selectedIndex",  asyncHandler(authorization), asyncHandler(get_service_image_url_for_overwrite), asyncHandler(get_file_signature))

router.get("/lodge/:lodgeId/image/:selectedIndex",  asyncHandler(authorization), asyncHandler(get_lodge_image_url_for_overwrite), asyncHandler(get_file_signature))

router.get("/room/:roomId/image/:selectedIndex",  asyncHandler(authorization), asyncHandler(get_room_image_url_for_overwrite), asyncHandler(get_file_signature))
