...
export async function list_service_from_webhook(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<any> {
...
export async function delete_service(
  req: Request,
  res: Response,
): Promise<any> {
  const user = req.user;
  ...
  const oldService = await prisma.service.findFirst({
    where: { serviceId: serviceId, userId: user.userId },
  });
...
export async function get_a_service_for_edit(
  req: Request,
  res: Response,
): Promise<any> {
  const serviceId = Number(req.params.serviceId);
...
export async function get_service_image_url_for_overwrite(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<any> {
...
export async function save_service_image_url(
  req: Request,
  res: Response,
): Promise<any> {
  const user = req.user;
...
export async function get_service_images_url_for_delete(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<any> {
