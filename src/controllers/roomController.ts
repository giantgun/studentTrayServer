...
export async function create_room_images_folder(req: Request, res: Response, next: NextFunction): Promise<any>{
  const user = req.user
  req.imageUploadFolderPath = `${user.email}/rooms/${user.room.length + 1}`
  next()
}
...
export async function list_room_from_webhook(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<any> {
...
export async function delete_room(req: Request, res: Response): Promise<any> {
  ...
  const oldRoom = await prisma.room.findFirst({
    where: { roomId: roomId, userId: user.userId },
  });
...
export async function get_a_room_for_edit(
  req: Request,
  res: Response,
): Promise<any> {
  const roomId = Number(req.params.roomId);
...
export async function get_room_image_url_for_overwrite(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<any> {
...
export async function save_room_image_url(
  req: Request,
  res: Response,
): Promise<any> {
  const user = req.user;
...
export async function get_room_images_url_for_delete(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<any> {
